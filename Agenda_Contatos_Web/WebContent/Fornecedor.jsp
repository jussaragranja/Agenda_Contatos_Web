...
<body>
	<div>
		<form role="form" action="FornecedorServlet">
			...
			<div>
				<label for="cnpj_">CNPJ: *</label> <input type="text" name="cnpj"
					class="form-control" id="cnpj" style="min-width: 50%;"
					placeholder="Digite o CNPJ" /><br />
			</div>
